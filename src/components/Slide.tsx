    ...
    <div className='outline-none border-none relative'>
        <div className="absolute left-[30px] md:left-[70px] max-w-[250px] sm:max-w-[350px] top-[50%] -translate-y-[50%]
         space-y-2 lg:space-y-4 bg-[#ffffffa2] sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none">
            ...
            <div className='border border-solid border-spacing-3 bg-gray-200 text-gray-700 text-[20px] md:text-[16px] p-2 px-4 rounded-lg inline-block cursor-pointer hover:bg-blackish hover:text-white'>
                <b>Shop Now</b>
            </div>
         </div>
